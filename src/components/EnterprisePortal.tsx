        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 max-w-md mx-auto p-6 rounded-2xl bg-white/[0.02] border border-[#d4af37]/20 backdrop-blur-md">
            <span className="inline-block bg-[#d4af37]/10 text-[#f3e5ab] text-[9px] font-mono font-bold px-2.5 py-1 rounded-full uppercase tracking-wider mb-4 animate-pulse">
              OFERTA EXCLUSIVA — ASSINATURA RECORRENTE
            </span>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <div className="text-center sm:text-left">
                <p className="text-[10px] font-mono text-white/40 uppercase tracking-wider">Preço Normal</p>
                <p className="text-base sm:text-lg text-white/40 line-through font-extrabold">R$ 347,90</p>
              </div>
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-center sm:text-left text-glow-gold">
                  <span className="text-2xl sm:text-3xl font-black text-[#f3e5ab]">R$ 247,90</span>
                  <span className="text-white text-xs sm:text-sm font-semibold ml-1.5">/ mensal</span>
                </p>
                <p className="text-[11px] text-white/70 font-semibold mt-0.5">Assinatura mensal recorrente</p>
              </div>
            </div>
            <p className="text-[10px] text-white/40 mt-4 font-sans">
              * Acesso completo e contínuo à formação semanal, gravações, comunidade exclusiva e scripts solares enquanto ativa sua assinatura.
            </p>
          </div>
