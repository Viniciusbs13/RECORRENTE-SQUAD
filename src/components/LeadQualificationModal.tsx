          ...
          >
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="mb-6 p-4 rounded-xl bg-white/[0.02] border border-[#d4af37]/15 flex items-center justify-between gap-4">
                <div>
                  <p className="text-[9px] font-mono text-white/40 uppercase tracking-wider">Assinatura — Comercial</p>
                  <p className="text-xs text-white/40 line-through mt-0.5">Era R$ 347,90</p>
                  <div className="flex flex-col mt-0.5">
                    <div>
                      <span className="text-lg sm:text-2xl font-black text-[#f3e5ab] text-glow-gold">R$ 247,90</span>
                      <span className="text-[11px] text-white font-semibold ml-1.5">/ mensal</span>
                    </div>
                  </div>
                </div>
                <div className="text-right">
                  <span className="inline-block bg-[#d4af37]/15 border border-[#d4af37]/30 text-[#f3e5ab] text-[9px] font-mono font-bold px-2.5 py-1 rounded-full uppercase tracking-wider animate-pulse">
                    Preço Especial
                  </span>
                  <p className="text-[9px] text-white/40 mt-1.5 font-sans">Acesso recorrente contínuo</p>
                </div>
              </div>
