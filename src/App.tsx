...
export default function App() {
  ...
  const VSL_SLIDES = [
    ...
    },
    {
      ...
      subtitle: "Por apenas R$ 247,90 mensais, você garante seu acesso à formação, pega os scripts e entra na comunidade. Clique abaixo e comece ainda essa semana.",
